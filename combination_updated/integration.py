...
address = web3.toChecksumAddress('0x4877a2098b218514347c95a3a82F6c3dD697caA0')
        ...
        for i in range(num_agents):
            ...
            for k in range (0, trades_pen):
                ...
                if (trade[3] == msg_sender):
                    ...
                    #if (trade[9]):
                    tx_hash1 = contract.functions.approveTrade(trade[0], trade[1], trade[2], trade[3], trade[4], trade[5], trade[6], trade[7], trade[8], trade[9], date, time, k).transact()
