...
for t in range(len(hours)):
    ...
    while ((prim > residual_primal or dual>resiudal_dual) and iteration< max_Iter):
        ...
        prim_difference = prim - prim_previous
        prim_difference = prim_difference * 10000
        if (prim_difference<5):
            ouch = ouch + 1
        prim_previous = prim
        ...
        #     Test_Residuals.to_csv(r'C:\Users\Inessa\Desktop\4th_Year\FYP\Methodology_Eth\optimisation\Final optimisation\Results\Test Residuals.csv')
        ...
        #     Test_Trades.to_csv(r'C:\Users\Inessa\Desktop\4th_Year\FYP\Methodology_Eth\optimisation\Final optimisation\Results\Test Trades.csv')
...
TradesDF.to_csv(r"C:\Users\Inessa\Desktop\4th_Year\FYP\Methodology_Eth\optimisation\Final optimisation\Results\Trade_Tests.csv")
SolarDF.to_csv(r'C:\Users\Inessa\Desktop\4th_Year\FYP\Methodology_Eth\optimisation\Final optimisation\Results\Solar_Tests.csv')
