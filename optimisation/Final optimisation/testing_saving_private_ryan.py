...
##THIS SCRIPT BUILDS ON TESTING_TWO_TIME_PERIODS.PY
#updated battery SOC for each time iteration
...
Trades = pd.DataFrame(columns=['Agent#','Time Period', 'TradeID', 'Quantity', 'Price', 'Avg. Price for Time Period', 'Amount paid/received for Trade Transaction'])
