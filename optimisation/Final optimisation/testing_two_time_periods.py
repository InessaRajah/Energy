...
##THIS SCRIPT BUILDS ON TESTING_AGENT_AUTOMATION.PY
# Added functionality- automatically create agents and run optimisation problem for two time periods
# also created a seperate functions.py file to store required functions
#also changed commission fee from 0 to 0.05 - decreased trading price nicely
...
for t in range(len(hours)):
    ...
    Commission_Fees = 0.05 #for decentralized model or 0
    penalty_factor = 0.01
