...
address = web3.toChecksumAddress('0x85007796C4f3FF36c2Af964e2aCeb06E62118872')
    ...
    if (optimal==0):
        ...
        for i in range(num_agents):
            ...
            for j in range(len(p)):
                ...
                print('Type tradeId for trade bids:', type(tradeID))
        ...
        for i in range(num_agents):
            ...
            for k in range (0, trades_pen):
                ...
                if (trade[3] == msg_sender):
                    ...
                    #if (trade[9]):
                    s = contract.functions.peers(msg_sender).call()
                    b = contract.functions.peers(trade[2]).call()
                    id_set = (s[0])+ (b[0]*10)
